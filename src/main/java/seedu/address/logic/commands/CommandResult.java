...
public class CommandResult {
     ...
     */
    public CommandResult(String feedbackToUser, boolean showHelp, boolean exit, boolean toCalendar) {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(feedbackToUser, showHelp, exit, toCalendar);
    }
